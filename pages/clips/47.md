---
layout: clip
title: "Nearly All Transgender Kids Stick With New Identity 5 Years Later"
clip: true
clip_id: 47
publisher: MedPage Today
date_display: May 6, 2022
byline: Michal Ruprecht
publisher_url: https://www.medpagetoday.com/endocrinology/generalendocrinology/98602?trw=no
caption_html: false
photo_credit: false
...
This included 94% who identified as binary transgender by the end of the fifth year, 2.5% who identified as cisgender, and 3.5% identifying as nonbinary, they reported in Pediatrics.
...
Echoing this sentiment, Jack Turban, MD, MHS, of Stanford University in California, told MedPage Today via email that "a social transition has value regardless of the ultimate gender trajectory."
...
The timely analysis follows a wave of new laws restricting gender-affirming care and other transgender rights, as well as subsequent pushback from the medical community. Despite claims by some politicians that minors are too young to transition, Olson's group demonstrated that nearly all children who transitioned before age 12 maintained their gender identity.

Additionally, the findings are in contrast with those of a previous study from The Netherlands that suggested ages 10 to 13 as a crucial retransition timeframe, as most of the youth in this sample who retransitioned did so prior to age 10.
...
The present analysis included 208 initially transgender girls and 109 initially transgender boys ages 3 to 12 years in the U.S. and Canada who were followed through an initiative called the TransYouth Project.
